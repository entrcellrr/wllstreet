...
/**
	 ...
	 * @comment: Parses a compare graph (max 2 data arrays)
	*/	
	public function parseCompare1($data1, $data2, $data3, $cfg = array()){
		try {
			//Parse config
			$this->parseConfig($cfg);
			...
			$dataStructure1 = $this->parseDataStructure($data1);
			$dataStructure2 = $this->parseDataStructure($data2);
			$dataStructure3 = $this->parseDataStructure($data3);
			$compareStructure = $this->compareDataStructures($dataStructure1, $dataStructure2, $dataStructure3);
